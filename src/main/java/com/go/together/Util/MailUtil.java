...
public class MailUtil {
    ...
    public static void Send(String emailAddress, String randomCode, String myEmail, String myPw) throws Exception {
        System.out.println("전송할 이메일 주소" + emailAddress + "랜덤 코드" + randomCode);
